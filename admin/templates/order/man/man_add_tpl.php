    ...
    <div class="container-fluid">
        <div class="row">
            <ol class="breadcrumb float-sm-left">
                ...
                <li class="breadcrumb-item"><a href="<?= $linkMan ?>" title="Quản lý đặt phòng">Quản lý đặt phòng</a></li>
                <li class="breadcrumb-item active">Thông tin đặt phòng <span class="text-primary">#<?= $item['code'] ?></span></li>
            </ol>
        </div>
    </div>
</section>
...
<section class="content">
    <form method="post" action="<?= $linkSave ?>" enctype="multipart/form-data">
        ...
        <div class="card card-primary card-outline text-sm">
            ...
            <div class="card-body row">
                ...
                <div class="form-group col-md-4 col-sm-6">
                    ...
                    <p><?= $func->formatMoney(@$item['total_price']) ?></p>
                </div>
                ...
                <div class="form-group col-12">
                    ...
                    <textarea class="form-control text-sm" name="data[content]" id="content" rows="5" placeholder="Ghi chú"><?= @$item['content'] ?></textarea>
                </div>
                <?php /* ?>
        ...
        <div class="card card-primary card-outline text-sm" style="display: none;">
            <div class="card-header">
                <h3 class="card-title">Chi tiết đặt phòng</h3>
            </div>
                ...
                <table class="table table-hover">
                    ...
                    <?php } else { ?>
                        <tbody>
                            ...
                            <?php } ?>
                            <tr>
                                <td colspan="5" class="title-money-cart-detail">Tổng giá trị đặt phòng:</td>
