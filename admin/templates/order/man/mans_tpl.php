...
<section class="content">
    ...
    <?php if (isset($config['order']['search']) && $config['order']['search'] == true) { ?>
        <div class="card card-primary card-outline text-sm">
            <div class="card-header">
                <h3 class="card-title">Tìm kiếm đặt phòng</h3>
            </div>
    ...
    <div class="card card-primary card-outline text-sm mb-0">
        <div class="card-header">
            <h3 class="card-title card-title-order d-inline-block align-middle float-none">Danh sách đặt phòng</h3>
            ...
            <table class="table table-hover">
                <thead>
                    <tr>
                        ...
                        <th class="align-middle">Mã đặt phòng</th>
