            ...
            <div class="card-body">
                ...
                <?php if (isset($config['setting']['coords_iframe']) && $config['setting']['coords_iframe'] == true) { ?>
                    <div class="form-group">
                        ...
                        <textarea class="form-control text-sm" name="data[options][slogan]" id="slogan" rows="5" placeholder="Slogan"><?= $func->decodeHtmlChars($flash->get('slogan')) ?: $func->decodeHtmlChars(@$options['slogan']) ?></textarea>
                    </div>
                    <div class="form-group">
                        <label for="slogan2">
                            <span>Slogan2:</span>
                        </label>
                        <textarea class="form-control text-sm" name="data[options][slogan2]" id="slogan2" rows="5" placeholder="Slogan2"><?= $func->decodeHtmlChars($flash->get('slogan2')) ?: $func->decodeHtmlChars(@$options['slogan2']) ?></textarea>
                    </div>
                    <div class="form-group">
                        <label for="copyright">
                            <span>Copyright:</span>
